...
// installed via the manifest's `display: standalone`), false in a browser tab. Mirrors
// useIsMobile's matchMedia-subscribe pattern; the one-shot isStandalone() helper in
