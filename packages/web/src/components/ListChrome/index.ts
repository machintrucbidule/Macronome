// Shared mobile list chrome (mobile-responsive S5). Created here with its first consumer
// (Journal); consumed read-only by Recettes (S6), Aliments (S7), Poids (S8). The Filtres
